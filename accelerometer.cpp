...
void loop() {
  //creation of variables
    ...
    dataStringAccel += "Date: " + getDate() + "\t" + "Time: " + getTime() + "\t" + "Acceleration values" + "\t" 
  +  "X-direction (g): " + String(sumaX,2) + "\t" + "Y-direction (g): " + String(sumaY,2) + "\t" + "Z-direction (g): " + String(sumaZ,2);

    String dataStringGyro = "";
    dataStringGyro += "Date: " + getDate() + "\t" + "Time: " + getTime() + "\t" + "Angle rate values" + "\t" 
  +  "Y-direction (degrees per second): " + String(sumgX,2) + "\t" + "Y-direction: (degrees per second) " + String(sumgY,2) + "\t" + "Z-direction (degrees per second): " + String(sumgZ,2);
